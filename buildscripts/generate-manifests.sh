...
# to generate the CRD definition' > deploy/crds/datapopulator-crd.yaml

cat deploy/crds/openebs.io_datapopulators.yaml >> deploy/crds/datapopulator-crd.yaml
...
# Do the modification in the code and run the `make manifests` command
# to generate the CRD definition' > deploy/crds/rsyncpopulator-crd.yaml

cat deploy/crds/openebs.io_rsyncpopulators.yaml >> deploy/crds/rsyncpopulator-crd.yaml
...
cat deploy/crds/datapopulator-crd.yaml >> deploy/data-populator-operator.yaml

# Add rsync populator v1alpha1 CRDs to the Operator yaml
cat deploy/crds/rsyncpopulator-crd.yaml >> deploy/data-populator-operator.yaml

# Add the data populator deployment to the Operator yaml
cat deploy/yamls/data-populator.yaml >> deploy/data-populator-operator.yaml

# Add the rsync populator deployment to the Operator yaml
cat deploy/yamls/rsync-populator.yaml >> deploy/data-populator-operator.yaml
